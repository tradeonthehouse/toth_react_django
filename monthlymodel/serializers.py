...
from .models import AlertDataModel,PositionalDataModel, BlogPostDataModel, UserStrategySubscribeModel
...
class UserStrategySubscribeSerializer(serializers.ModelSerializer):
    class Meta:
        model = UserStrategySubscribeModel
        fields = '__all__'